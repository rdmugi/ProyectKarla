...
{
    class BoletaDePensamientoMatematico
    {
        ...
        public BoletaDePensamientoMatematico() { }

        public BoletaDePensamientoMatematico(int pId, string pNombre, string pGradoyGrupo, string pEsperado, string pDesarrollo, string pRequiereApoyo, string pResultado)
